...
if ($source == $dest)
{
  echo"<h1 style='color: red'><center>Selected source and destination same , Please refill the details  </center></h1><br><br>";
  echo"<center>";
}
else{
	echo "<h1 style='color: red'><center><b><img src=https://img.icons8.com/cotton/80/000000/route.png/>SELECT ROUTE AND PROCEED TO CHECKOUT :</center></b></h1>";
